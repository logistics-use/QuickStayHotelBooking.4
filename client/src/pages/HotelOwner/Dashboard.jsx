...
const Dashboard = () => {
  ...
  return (
    <div>
      <Title align='left' font='outfit' title='Dashboard'  subtitle='Monitor your room listings, track boolings and analyze revenue-all in one place.Stay updated with real-time insights and performance metrics.' />
